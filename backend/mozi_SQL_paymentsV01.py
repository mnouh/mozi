                ...
                if tweet[u'entities'][u'hashtags'][hashtag][u'text'] == 'pay':
                    ...
                    if len(tweet[u'entities'][u'user_mentions'])>1:
                        ...
                        try: #filter for users that don't exist
                            ...
                            message="@%s, that user does not exist on Twitter. Try fixing the name again!"%str(tweet[u'user'][u'screen_name'])
                            print message
                            api.update_status(message)
                            break
                        ...
                        if test!=[True,True]:
                            ...
                            note_data=[['message','new transaction pending'],['transactionId',trans_id],['type',1]]
                            encode_data= json.dumps(note_data)
                    ...
                    if replyTweetID != None:
                        ...
                        if validTrans==True:
                            if idReceiver==True:
                                ...
                                message="@%s @%s, payment has been accepted!"%(senderName,payerName)
                                api.update_status(message)
