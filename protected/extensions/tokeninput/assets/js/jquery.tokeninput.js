...
$.TokenList = function (input, url_or_data, settings) {
    ...
    var input_box = $("<input type=\"text\"  placeholder=\"Enter Mozi, @twitter name, e-mail, or phone # of user\" autocomplete=\"off\">")
        .css({
            outline: "none",
            width:408
    ...
    var token_list = $("<ul style=\"display:inline-block;\" />")
    ...
    function resize_input() {
        ...
        input_box.width(input_resizer.width() + 408);
    }
