...
class CreditCard extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('userId, number, type, security', 'required'),
			array('userId, number, type, security, primary', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, userId, number, type, security, primary', 'safe', 'on'=>'search'),
		);
	}
